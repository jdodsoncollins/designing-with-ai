...
Two one-shots, same prompt, same model (Astra). One run had Appllama MCP + skills. The other had none. The left app looks like every AI astrology app.
...
Flow and look are different products on purpose. Copying both from one app produces a clone. Crossing them produces a specific new thing.
...
- Name the product and attach frames. Do not re-describe Blank Spaces in prose (“soft serif, cream, generous margin”). The model will average that description with a thousand other cream-serif landing pages.
